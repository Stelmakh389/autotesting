    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment_type', models.CharField(choices=[('СИ', 'СИ'), ('ИО', 'ИО'), ('ВО', 'ВО')], max_length=2, verbose_name='Тип оборудования')),
            ...
            options={
                ...
                'ordering': ['-id'],
                'indexes': [models.Index(fields=['equipment_type'], name='equipment_e_equipme_ce5345_idx'), models.Index(fields=['name'], name='equipment_e_name_8baf3a_idx'), models.Index(fields=['srok_poverk'], name='equipment_e_srok_po_b1ce13_idx')],
            },
        ),
        migrations.CreateModel(
            name='EquipmentGroup',
